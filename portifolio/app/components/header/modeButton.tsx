...
export const SwitchMode = () => {
    return (
        <li>
            <Button  variant="bordered" size="sm" className="border-white dark:hover:bg-[#9651AE] hover:border-none transition-colors" isIconOnly aria-label="alternar entre modo claro e escuro" >
                <MoonSvg/>
            </Button>
        </li>
    )
