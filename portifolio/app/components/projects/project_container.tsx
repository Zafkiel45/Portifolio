...
export const Project = () => {
    ...
    return (
        <section className="w-screen py-5 h-auto px-2 flex flex-col gap-8">
            <div className="text-center text-xl font-bold w-full">
                <h1 className={noto_sans.className}>Principais Projetos</h1>
            </div>
            <ProjectDescription content={contents[0].todoList} title="To-do List" link="https://next-todo-list-336m.vercel.app/" />
            <ProjectDescription content={contents[1].clinic} title="Clínica" link="https://clinic-website-tau.vercel.app/" />
            <ProjectDescription content={contents[2].ecommerce} title="Ecommerce" link="https://e-commerce-zafkiel45.vercel.app/" />
            <ProjectDescription content={contents[3].calc} title="Calculadora" link="https://calculate-next.vercel.app/" />
        </section>
    )
}